...
public class TwoFragment extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mReviewsRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if(!movies.contains(postSnapshot.child("title").getValue().toString())){
                        movies.add(postSnapshot.child("title").getValue().toString());
                    }
        ...
        mLinearLayout = (LinearLayout) view.findViewById(R.id.rl2);
        _input = (AutoCompleteTextView) view.findViewById(R.id.search_input);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_1, movies);
        _input.setAdapter(adapter);//setting the adapter data into the AutoCompleteTextView
            ...
            public void onClick(View v)
            {
                ...
                mReviewsRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                            if (postSnapshot.child("title").getValue().toString().equals(_input.getText().toString())) {
